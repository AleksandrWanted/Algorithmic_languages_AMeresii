# задание 1: Опишите себя используя список
...
# задание 2: Опишите себя используя словарь
...
# задание 3: Обьясните какое описание удобнее с точки зрения обработки информации и почему

# С точки зрения обработки информации удобнее описание в виде словаря так как информация структурирована, доступ к ней проще,
# возможен поиск и изменение значения по ключу, который не привязан к индексу.

# Пример Список:

# Мы должны знать какому индексу соответствуют те или иные данные, либо изобретать костыльные решения, например как в данном примере, где
